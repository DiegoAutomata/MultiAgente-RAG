          ...
          {success ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-zinc-900 border border-zinc-700 rounded-xl hover:bg-zinc-800 hover:border-zinc-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium text-sm mb-4"
              >
